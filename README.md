 ...
 **Progress Status**
 ...
 |[Day 10](/docs/Day_10.md)| GLS of the implemented RISC-V CPU Core | ![](https://progress-bar.dev/100/?title=done) |
 |[Day 11](/docs/Day_11.md)| Advanced Synthesis and STA with DC | ![](https://progress-bar.dev/40/?title=progress) |
 |[Day 12](/docs/Day_12.md)| Circuit Design using sky130 | ![](https://progress-bar.dev/10/?title=progress) |
