...
# -----------------------------------------------------------------------------
# Putting these values here from config.tcl to run STA indepedently in OpenSTA
# -----------------------------------------------------------------------------
...
set clk_latency_min_value [ expr 0.10 * $::env(CLOCK_PERIOD) ]; # 10%
set clk_latency_max_value [ expr 0.20 * $::env(CLOCK_PERIOD) ]; # 20%
...
set_clock_latency -source -min $clk_latency_min_value clk
set_clock_latency -source -max $clk_latency_max_value clk
set_clock_uncertainty $clk_uncertainty_value [get_clocks $::env(CLOCK_PORT)]
set_clock_transition -min $clk_transition_min_value [get_clocks $::env(CLOCK_PORT)]
set_clock_transition -max $clk_transition_max_value [get_clocks $::env(CLOCK_PORT)]
