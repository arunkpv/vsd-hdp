...
\SV
   ...
   m4_include_lib(['https://raw.githubusercontent.com/arunkpv/vsd-hdp/main/code/riscv/verilog/include/risc-v_defs.tlv'])
...
\TLV imem(@_stage)
   ...
   @_stage
      ...
      \SV_plus
         ...
         m4_forloop(['m4_instr_ind'], 0, M4_NUM_INSTRS, ['assign instrs[m4_instr_ind] = m4_echo(['m4_instr']m4_instr_ind;['']m4_new_line               )'])
      /M4_IMEM_HIER
