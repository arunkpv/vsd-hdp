\TLV_version [\source top.tlv] 1d -p verilog --bestsv --noline --clkAlways --inlineGen --iArgs --verbose: tl-x.org
\SV
...
\TLV
   ...
   |cpu
      @0
         ...
         $imem_rd_en = !$reset;
         $imem_rd_addr[4-1:0] = $pc[4+1:2]; //imem_rd_addr[31:0]
   ...
   //  o CPU visualization
   |cpu
      \source /raw.githubusercontent.com/arunkpv/vsdhdp/main/code/riscv/verilog/include/riscvshelllib.tlv 20   // Instantiated from top.tlv, 321 as: m4+imem(@1)
      ...
      \source /raw.githubusercontent.com/arunkpv/vsdhdp/main/code/riscv/verilog/include/riscvshelllib.tlv 73   // Instantiated from top.tlv, 322 as: m4+rf(@2, @3)
         // Reg File
         @3
            /xreg[31:0]
      ...
      \source /raw.githubusercontent.com/arunkpv/vsdhdp/main/code/riscv/verilog/include/riscvshelllib.tlv 90   // Instantiated from top.tlv, 323 as: m4+dmem(@4)
         // Data Memory
         @4
            /dmem[15:0]
