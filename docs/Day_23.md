...
## 23.1 Lab: Steps to convert grid info to track info
...
## 23.2 Lab: Adding the extracted LEF file into OpenLANE flow for picorv32a design
...
## 23.3 Introduction to Delay Tables
...
## 23.4 Lab: Configure synthesis settings to fix the timing violations and improve slack
...
## 23.5 Timing analysis with ideal clocks using openSTA

**Note**: We have already gone through STA basics previously. We will capture the important essentials once again here.  

### 23.5.1 Setup timing analysis and introduction to flip-flop setup time
<!---
...
### 23.5.2 Lab: Configure OpenSTA for Post-synth timing analysis
...
### 23.5.3 Lab: Optimize Synthesis to reduce setup violations
...
### 23.5.4 Lab: Steps to do basic Timing ECO
...
## 23.6 Clock Tree Synthesis using TritonCTS and Signal Integrity
...
### 23.6.1 Clock tree routing and buffering using H-Tree algorithm
  * **H-Tree algorithm**
...
### 23.6.2 Clock Signal Integrity: Crosstalk and Clock Net Shielding
  * **Crosstalk Glitch**
...
### 23.6.3 Lab: Steps to run CTS using TritonCTS
...
### 23.6.4 Lab: Steps to verify CTS runs
...
## 23.7 Timing Analysis with real clocks using OpenSTA

### 23.7.1 Setup timing analysis using real clocks

### 23.7.2 Hold timing analysis using real clocks

### 23.7.3 Lab: Steps to analyze timing with real clocks (Post-CTS STA) using OpenSTA
...
### 23.7.4 Lab: Steps to observe impact of bigger CTS buffers on setup and hold timing
